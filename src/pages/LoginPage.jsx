        ...
        <div className="flex-1 bg-secondary p-4 justify-between flex gap-6">
            ...
            <div className="flex flex-col">
                ...
                <form onSubmit={handleLogin} className="flex flex-col flex-1">
                    <label htmlFor="user_email" className=" text-accent-light">Email</label>
                    <input className="bg-gray-200 my-1 rounded-lg p-2 py-3 text-xl " placeholder="Email *" type="email" onChange={(e) => setEmail(e.target.value)} required />
                    <label htmlFor="user_password" className=" text-accent-light">Password</label>
                    <input className="bg-gray-200 my-1 rounded-lg p-2 py-3 text-xl " placeholder="Password *" type="password" onChange={(e) => setPassword(e.target.value)} required />
