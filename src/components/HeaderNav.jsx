...
export default function HeaderNav() {
  ...
  return (
    <nav className="col-span-3 max-h-12 bg-primary text-secondary flex justify-between px-2 py-3">
      <div>
        <p className="font-bold">MMC Rentals Management</p>
      </div>
      <div className="relative flex gap-4 text-2xl">
        ...
        {isMenuOpen && (
          <div className="select-none absolute top-full right-0 mt-2 w-48 bg-white shadow-lg rounded-md py-1 z-10">
            ...
            <a
              href="#"
              className="block px-4 py-2 text-primary  text-sm hover:bg-gray-100"
            >
              Menu
            </a>
            <button
              ...
              href="#"
              className="block px-4 py-2 text-red-500 font-bold text-sm hover:bg-gray-100 border-t-2 w-full"
            >
              Log out
            </button>
          </div>
